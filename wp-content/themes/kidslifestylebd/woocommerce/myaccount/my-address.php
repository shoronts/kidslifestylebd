...
<?php if (! wc_ship_to_billing_address_only() && wc_shipping_enabled()) : ?>
	<div class="u-columns woocommerce-Addresses woocommerce-customer-details col2-set addresses">
	<?php endif; ?>
	...
	<?php foreach ($get_addresses as $name => $address_title) : ?>
		...
		<div class="u-column<?php echo $col < 0 ? 1 : 2; ?> col-<?php echo $oldcol < 0 ? 1 : 2; ?> woocommerce-Address">
			<header class="woocommerce-Address-title title">
				...
				<a style="color: #333;" href="<?php echo esc_url(wc_get_endpoint_url('edit-address', $name)); ?>" class="edit my-3 float-none text-decoration-none d-flex align-items-start align-items-center">
